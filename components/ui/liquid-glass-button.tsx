...
function LiquidButton({
  ...
  const surfaceStyle: React.CSSProperties = {
    ...
    boxShadow: pressed
      ? "inset 0 1px 1px rgba(255,255,255,0.12), 0 1px 4px rgba(0,0,0,0.10)"
      : hovered
        ? isDark
  ...
  return (
    <Comp
      data-slot="button"
      className={cn("relative backdrop-blur-md", liquidbuttonVariants({ variant, size, className }))}
      style={wrapperStyle}
      ...
      {...props}
    >
      {/* Frosted glass base — blurs what's behind */}
      ...
      {/* Glass surface: border highlight + shadow */}
      <div
        className="absolute inset-0 rounded-full border"
        style={{
          ...surfaceStyle,
          borderColor: isDark ? "rgba(255,255,255,0.13)" : "rgba(255,255,255,0.70)",
        }}
      />
        ...
        <div
          ...
          style={{
            background: isDark
              ...
              : "linear-gradient(110deg, transparent 25%, rgba(255,255,255,0.60) 50%, transparent 75%)",
          }}
        />
      </div>
